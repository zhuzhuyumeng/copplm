...
# 自己训练{'valid_auc': 0.676173276895907, 'valid_uauc': 0.6162391373896398, 'test_auc': 0.6493660871840061, 'test_uauc': 0.6354343795924502, 'epoch': 467}
# save version....
# if __name__=='__main__':
#     # lr_ = [1e-1,1e-2,1e-3]
#     lr_=[1e-3] #1e-2
...
#                 }
#                 print(train_config)
#                 save_path += "1020_ml1m_oodv2_best_model_d" + str(embedding_size)+ 'lr-'+ str(lr) + "wd"+str(wd) + ".pth"
    ...
    for lr in lr_:
        for wd in dw_:
            for embedding_size in embedding_size_:
                ...
                # save_path = "collm-trained-models/0912_ml1m_oodv2_best_model_d256lr-0.001wd0.0001.pth" # 222
